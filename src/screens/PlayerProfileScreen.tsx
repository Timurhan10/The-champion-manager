...
function AttributeBar({ label, value }: { label: string; value: number }) {
  return (
    <div className="flex items-center gap-3">
      ...
      <span className="w-8 text-right text-xs text-white font-bold">{value}</span>
    </div>
  );
}
...
export default function PlayerProfileScreen() {
  ...
  return (
    <ScreenBackground image="5.jpeg" className="p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-800/80 backdrop-blur rounded-lg p-6 mb-6">
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <div className="flex items-center gap-3 mt-2">
                ...
                <span className="text-gray-400 text-xs">{player.age} yaş</span>
                <span className="text-gray-400 text-xs">{player.nationality}</span>
              </div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-emerald-400">{player.overallRating}</div>
              <div className="text-[10px] text-gray-500">OVR</div>
            </div>
          </div>

          <div className="mt-4">
            <p className="text-[10px] text-gray-500 mb-1">Kondisyon</p>
            ...
            <p className="text-[10px] text-gray-400 mt-1 text-right">{player.currentStamina}%</p>
          </div>
        </div>

        <div className="bg-gray-800/80 backdrop-blur rounded-lg p-6 mb-6 space-y-3">
          <h2 className="text-white font-semibold text-sm mb-3">Nitelikler</h2>
        ...
        {isOnMyTeam && (
          <button
            ...
            className="w-full py-3 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg transition-colors text-sm"
          >
            Sat
          </button>
        )}
